<x-app-layout>
                        ...
                        >
                            ...
                            <div class="mb-5">
                                ...
                                <textarea
                                    ...
                                    name="content"
                                    rows="4"
                                    class="@error('content') is-invalid @enderror block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <div class="mb-5">
                                ...
                                />
                                <img src="/media/{{ $gallery->image }}" class="w-24 h-24 rounded-full">
                                @error('image')
                                <div class="form-text text-danger">
                                    {{ $message }}
                                </div>
    ...
    <script>
        ClassicEditor.create(document.querySelector("#contents")).catch(
            (error) => {
                console.error(error);
            }
        );
